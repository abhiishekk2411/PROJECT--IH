...
const en = {
  ...
  dashboard: {
    title: 'Dashboard',
    welcome: 'Welcome to FasalNirnay',
    welcomeSubtitle: 'Your smart crop selling assistant',
    startNewAnalysis: 'Analyze New Crop',
    totalAnalyses: 'Total Analyses',
    avgNetReturn: 'Avg Net Return',
    bestPerformingCrop: 'Best Crop',
    nearbyMandis: 'Nearby Markets',
    latestRecommendation: 'Latest Recommendation',
    viewFullAnalysis: 'View Details',
    quickActions: 'Quick Actions',
    analyzeNewCrop: 'Analyze Crop',
    compareMarkets: 'Compare Markets',
    askCropAssistant: 'Ask Assistant',
    noHistoryTitle: 'No Analyses Yet',
    noHistorySubtitle: 'Start by analyzing your first crop.',
    noCrop: 'None',
    noMandi: 'None'
  },
  ...
  results: {
    ...
    imageDisclaimer: 'This photo was used for crop identification only. Disease detection is not available.',
    uploadedCropPhoto: 'Uploaded Crop Photo',
    detectedCropLabel: 'Identified Crop',
    detectedVarietyLabel: 'Variety',
  ...
  imageInput: {
    ...
    guidance3: 'Show whole plant/fruit',
    guidance4: 'Avoid blurry images',
    notAnalyzed: 'Image is not analyzed yet. Please confirm crop details below.',
    errorInvalid: 'Not an image file. Please upload JPG or PNG.',
    errorLarge: 'Image is too large. Please use a smaller file.',
    analyzingImage: 'Analyzing image...',
    cropDetected: 'We detected this crop from the photo',
    confirmCrop: 'Yes, this is correct',
    changeCrop: 'Change',
    confidenceHigh: 'Confidence: Very High',
    confidenceMedium: 'Confidence: Good',
    confidenceLow: 'Confidence: Not entirely sure',
    imageAnalysisFailed: 'Could not identify crop from photo.',
    manualFallback: 'You can manually enter the crop details below.',
    imageDisclaimer: 'Image identification is a suggestion. Please verify the actual crop and variety yourself.'
  },
